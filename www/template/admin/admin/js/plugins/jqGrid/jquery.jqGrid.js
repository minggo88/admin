...
* http://www.trirand.com/blog/?s=jqgrid
* http://www.trirand.com/jqgridwiki/doku.php?id=wiki:colmodel_options&s[]=colmodel
		...
		return this.each(function () {
			if (!this.grid) {
				var d = b.extend(!0, {
                    ...
                    gridview: !1,
                    grouping: !1,
                    groupingView: {groupField: [],groupOrder: [],groupText: [],groupColumnShow: [],groupSummary: [],showSummaryOnHide: !1,sortitems: [],sortnames: [],summary: [],summaryval: [],plusicon: "ui-icon-circlesmall-plus",minusicon: "ui-icon-circlesmall-minus",displayField: [],groupSummaryPos: [],formatDisplayField: [],_locgr: !1},
                    headertitles: !1,
                    height: 150,
                    hiddengrid: !1,
                    hidegrid: !0,
			...
			return this.each(function () {
				...
				if (e.grid) {
					...
					if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0])
						...
						q = !1;
						b.tmplNames && b.tmplNames.length && (q = !0, m = b.tmplLabel, m += "<select class='ui-template'>", m += "<option value='default'>초기화</option>", a.each(b.tmplNames,
								function (a, b) {
