$(function() {
    var datatable = $('.dataTables-customers').addClass( 'nowrap' ).DataTable({
        ...
        , "serverSide": true
        , "searching": false
        , 'pageLength': 10 , "lengthMenu": [ [10, 25, 50, 75, 100], [10, 25, 50, 75, 100] ] , "lengthMenu": [ [10, 25, 50, 75, 100], [10, 25, 50, 75, 100] ]
        , "order": [[ 1, 'desc' ]]
        , "ajax": {
            type: "post",
            url: "?",
        ...
        , "columns": [
            ...
            {
                data: 'symbol', "className": "dt-body-center", "orderSequence": ['desc', 'asc'], "orderable": true
                , render: function (data, type, row) { 
                    return row.symbol_name + '('+data+')';
                    // return data == 'USD' ?
                    // '<a href="/wallet/admin/ledgerAdmin.php?pg_mode=transaction&symbol=' + data + '&search=' + row.userid + '">' + data + '</a>' :
                    // '<a href="/coins/admin/tradehistoryAdmin.php?pg_mode=list&symbol=' + data + '&search=' + row.userid + '">' + data + '</a>';
                }
            },
