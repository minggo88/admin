$(function() {
    ...
    var datatable = $('.dataTables-customers').addClass( 'nowrap' ).DataTable({
        ...
        , "buttons": [
            ...
            {extend: 'pdfHtml5', title: 'InoutList', fontSize: '10px', orientation: 'landscape', pageSize: 'A4' },
    ...
    $('#btn-search').click(function(){
        ...
        start_date = $('[name=start_date]').val();
        end_date = $('[name=end_date]').val();
        //console.log("?pg_mode=list&symbol="+getURLParameter('symbol')+"&name="+name+"&txn_type="+ getURLParameter('txn_type')+"&s_div="+s_div+"&start_date="+start_date+"&end_date="+end_date);
