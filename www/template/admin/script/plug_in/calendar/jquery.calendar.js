...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function newDatepickerHTML () {
			...
			jQuery("thead",table).append('<tr class="days"><th>일</th><th>월</th><th>화</th><th>수</th><th>목</th><th>금</th><th>토</th></tr>');
			jQuery("tfoot",table).append('<tr><td colspan="2"><span class="today">오늘</span></td><td colspan="3">&nbsp;</td><td colspan="2"><span class="close">닫기</span></td></tr>');
