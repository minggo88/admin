    ...
    ({
        ...
        3: [function (t, e, a) {
                ...
                o.prototype = {
                    ...
                    clone: function () {
                        ...
                        n = a.values;
                        for (var r in i)
                            i.hasOwnProperty(r) && (t = i[r], e = {}
                                .toString.call(t), "[object Array]" === e ? n[r] = t.slice(0) : "[object Number]" === e && (n[r] = t));
                        return a
                    }
                },
                o.prototype.spaces = {
                ...
                o.prototype.setValues = function (t, e) {
                    ...
                    if (o.alpha = Math.max(0, Math.min(1, void 0 === s ? o.alpha : s)), "alpha" === t)
                        return !1;
                    for (a = 0; a < t.length; a++)
                        n = Math.max(0, Math.min(l[t][a], o[t][a])), o[t][a] = Math.round(n);
                    for (var u in r)
                        u !== t && (o[u] = i[t][u](o[t]));
                    return !0
                },
        ...
        4: [function (t, e, a) {
                ...
                function V(t) {
                    ...
                    o = t[1] / 100,
                    r = t[2] / 100;
                    return e = 3.2406 * n + -1.5372 * o +  - .4986 * r,
                    a =  - .9689 * n + 1.8758 * o + .0415 * r,
                    i = .0557 * n +  - .204 * o + 1.057 * r,
                ...
                function B(t) {
                    ...
                    r = t[1],
                    l = t[2];
                    return 8 >= o ? (a = 100 * o / 903.3, n = a / 100 * 7.787 + 16 / 116) : (a = 100 * Math.pow((o + 16) / 116, 3), n = Math.pow(a / 100, 1 / 3)),
                    ...
                    t.controllers.bar = t.DatasetController.extend({
                        ...
                        draw: function (t) {
                            ...
                            e.each(a.getMeta().data, function (t, e) {
                                ...
                                null == n || isNaN(n) || t.transition(i).draw()
                            }, a)
                        },
                ...
                e.exports = function (t) {
                    ...
                    t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                        ...
                        updateElement: function (t, a, i) {
                            ...
                            i && s.animateRotate || (v.startAngle = 0 === a ? l.rotation : n.getMeta().data[a - 1]._model.endAngle, v.endAngle = v.startAngle + v.circumference),
                            t.pivot()
                        },
                        removeHoverStyle: function (e) {
                ...
                e.exports = function (t) {
                    ...
                    e.extend(t.Controller.prototype, {
                        ...
                        resize: function (a) {
                            ...
                            l = n.aspectRatio,
                            s = i.options.maintainAspectRatio && !1 === isNaN(l) && isFinite(l) && 0 !== l ? r / l : e.getMaximumHeight(o),
                        ...
                        buildOrUpdateControllers: function () {
                            ...
                            if (e.each(a.data.datasets, function (e, o) {
                                    ...
                                    i.push(r.type),
                                    r.controller ? r.controller.updateIndex(o) : (r.controller = new t.controllers[r.type](a, o), n.push(r.controller))
                                }, a), i.length > 1)
                ...
                e.exports = function (t) {
                    ...
                    e.extend(t.Element.prototype, {
                        ...
                        transition: function (t) {
                            ...
                            1 === t ? (a._view = a._model, a._start = null, a) : (a._start || a.pivot(), e.each(a._model, function (i, n) {
                                    if ("_" === n[0]);
        ...
        25: [function (t, e, a) {
                ...
                e.exports = function (t) {
                    ...
                    o.getValueAtIndexOrDefault = function (t, e, a) {
                        return null == t ? a : o.isArray(t) ? e < t.length ? t[e] : a : t
                    },
                    ...
                    var r = o.easingEffects = {
                        ...
                        easeInOutElastic: function (t) {
                            ...
                            a = 0,
                            i = 1;
                            return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (a || (a = .3 * 1.5 * 1), i < Math.abs(1) ? (i = 1, e = a / 4) : e = a / (2 * Math.PI) * Math.asin(1 / i), 1 > t ? i * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / a) *  - .5 : i * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / a) * .5 + 1)
                        },
                    ...
                    o.retinaScale = function (t) {
                        ...
                        1 !== o && (a.height = n * o, a.width = i * o, e.scale(o, o), t.originalDevicePixelRatio = t.originalDevicePixelRatio || o),
                        a.style.width = i + "px",
                        a.style.height = n + "px"
                    },
                    o.clear = function (t) {
                    ...
                    o.longestText = function (t, e, a, i) {
                        ...
                        var l = 0;
                        o.each(a, function (e) {
                            null != e && !0 !== o.isArray(e) ? l = o.measureText(t, n, r, l, e) : o.isArray(e) && o.each(e, function (e) {
                                null == e || o.isArray(e) || (l = o.measureText(t, n, r, l, e))
                            })
                        });
                        var s = r.length / 2;
                        if (s > a.length) {
        ...
        26: [function (t, e, a) {
                ...
                e.exports = function () {
                    var t = function (e, a) {
                        ...
                        (isNaN(i.aspectRatio) || !1 === isFinite(i.aspectRatio)) && (i.aspectRatio = void 0 !== a.aspectRatio ? a.aspectRatio : 2),
                        ...
                        draw: function () {
                            ...
                            if (i.display) {
                                ...
                                y = function (t, e, a, i) {
                                    ...
                                    a.hidden && (u.beginPath(), u.lineWidth = 2, u.moveTo(b + f / 2 + t, e + f / 2), u.lineTo(b + f / 2 + t + i, e + f / 2), u.stroke())
                                },
                                k = a.isHorizontal();
                                d = k ? {
                                    x: a.left + (l - s[0]) / 2,
                                ...
                                e.each(a.legendItems, function (t, e) {
                                    ...
                                    r = d.x,
                                    c = d.y;
                                    k ? r + o >= l && (c = d.y += f + n.padding, d.line++, r = d.x = a.left + (l - s[d.line]) / 2) : c + S > a.bottom && (r = d.x = r + a.columnWidths[d.line] + n.padding, c = d.y = a.top, d.line++),
                                    x(r, c, t),
                                    v[e].left = r,
                                    v[e].top = c,
                                    y(r, c, t, i),
                ...
                e.exports = function (t) {
                    ...
                    t.plugins = {
                        ...
                        notify: function (t, e) {
                            ...
                            o = n.length;
                            for (a = 0; o > a; ++a)
                                if (i = n[a], "function" == typeof i[t] && !1 === i[t].apply(i, e || []))
                                    return !1;
                            return !0
                        }
                    },
                ...
                e.exports = function (t) {
                    ...
                    t.Scale = t.Element.extend({
                        ...
                        fit: function () {
                            ...
                            if (i.width = d ? a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth : s ? b : 0, i.height = d ? s ? b : 0 : a.maxHeight, l.display && s && (d ? i.height += 1.5 * g : i.width += 1.5 * g), r.display && s) {
                                a.longestTextCache || (a.longestTextCache = {});
                        ...
                        getRightValue: function t(e) {
                            return null == e ? NaN : "number" == typeof e && isNaN(e) ? NaN : "object" == typeof e ? e instanceof Date || e.isValid ? e : t(this.isHorizontal() ? e.x : e.y) : e
                        },
                        ...
                        draw: function (a) {
                            ...
                            if (n.display) {
                                ...
                                if (e.each(i.ticks, function (t, r) {
                                        if (null != t) {
                                            ...
                                            if ((!s || l) && null != t) {
                                                var c,
                                                f;
                                                r === (void 0 !== i.zeroLineIndex ? i.zeroLineIndex : 0) ? (c = u.zeroLineWidth, f = u.zeroLineColor) : (c = e.getValueAtIndexOrDefault(u.lineWidth, r), f = e.getValueAtIndexOrDefault(u.color, r));
                                                var p,
                                                m,
                                                b,
                                                v,
                                        ...
                                        L = 0;
                                        if (g)
                                            V = i.left + (i.right - i.left) / 2, O = "bottom" === n.position ? i.bottom - S / 2 : i.top + S / 2;
                                        else {
                                            var B = "left" === n.position;
                                            V = B ? i.left + S / 2 : i.right - S / 2,
                                            O = i.top + (i.bottom - i.top) / 2,
                                            L = B ?  - .5 * Math.PI : .5 * Math.PI
                                        }
                                        l.save(),
                                        l.translate(V, O),
                                        l.rotate(L),
                                ...
                                if (u.drawBorder) {
                                    ...
                                    g ? (H = N = "top" === n.position ? i.bottom : i.top, H += E, N += E) : (W = z = "left" === n.position ? i.right : i.left, W += E, z += E),
                                    l.beginPath(),
                                    l.moveTo(W, H),
                                    l.lineTo(z, N),
                                    l.stroke()
                    ...
                    t.Title = t.Element.extend({
                        ...
                        draw: function () {
                            ...
                            if (o.display) {
                                ...
                                i.font = h,
                                a.isHorizontal() ? (l = p + (b - p) / 2, s = g + (m - g) / 2) : (l = "left" === o.position ? p + d / 2 : b - d / 2, s = g + (m - g) / 2, f = Math.PI * ("left" === o.position ?  - .5 : .5)),
                                i.save(),
                                i.translate(l, s),
                                i.rotate(f),
                                i.textAlign = "center",
                ...
                e.exports = function (t) {
                    ...
                    t.Tooltip = t.Element.extend({
                        ...
                        getBackgroundPoint: function (t, e) {
                            ...
                            "top" === l ? a.y += s : a.y -= "bottom" === l ? e.height + s : e.height / 2,
                        ...
                        drawTitle: function (t, e, a, i) {
                            ...
                            if (o.length) {
                                ...
                                s = e.titleFontSize,
                                d = e.titleSpacing,
                                u = n.color(e.titleFontColor);
                                for (a.fillStyle = u.alpha(i * u.alpha()).rgbString(), a.font = n.fontString(s, e._titleFontStyle, e._titleFontFamily), r = 0, l = o.length; l > r; ++r)
                                    a.fillText(o[r], t.x, t.y), t.y += s + d, r + 1 === o.length && (t.y += e.titleMarginBottom - d)
                            }
                        },
                        drawBody: function (t, e, a, i) {
                            ...
                            n.each(l, function (r, l) {
                                ...
                                n.each(r.lines, function (r) {
                                    h && (a.fillStyle = n.color(e.legendColorBackground).alpha(i).rgbaString(), a.fillRect(t.x, t.y, o, o), a.strokeStyle = n.color(e.labelColors[l].borderColor).alpha(i).rgbaString(), a.strokeRect(t.x, t.y, o, o), a.fillStyle = n.color(e.labelColors[l].backgroundColor).alpha(i).rgbaString(), a.fillRect(t.x + 1, t.y + 1, o - 2, o - 2), a.fillStyle = d),
                                    c(r)
                                }),
                                n.each(r.after, c)
                            }),
                ...
                e.exports = function (t) {
                    ...
                    t.elements.Line = t.Element.extend({
                        ...
                        draw: function () {
                            ...
                            o.save(),
                            i._children.length > 0 && n.fill && (o.beginPath(), e.each(i._children, function (t, a) {
                            ...
                            o.beginPath(),
                            e.each(i._children, function (t, a) {
                ...
                e.exports = function (t) {
                    ...
                    i = t.Scale.extend({
                        determineDataLimits: function () {
                            ...
                            void 0 !== a.options.ticks.min && (t = e.indexOf(a.chart.data.labels, a.options.ticks.min), a.minIndex = -1 !== t ? t : a.minIndex),
                            void 0 !== a.options.ticks.max && (t = e.indexOf(a.chart.data.labels, a.options.ticks.max), a.maxIndex = -1 !== t ? t : a.maxIndex),
                        ...
                        getPixelForValue: function (t, e, a, i) {
                            ...
                            if (n.isHorizontal()) {
                                ...
                                return n.options.gridLines.offsetGridLines && i && (s += l / 2),
                                n.left + Math.round(s)
                            }
                            var d = n.height - (n.paddingTop + n.paddingBottom),
                            u = d / o,
                            c = u * (e - n.minIndex) + n.paddingTop;
                            return n.options.gridLines.offsetGridLines && i && (c += u / 2),
                            n.top + Math.round(c)
                        },
                        getPixelForTick: function (t, e) {
                        ...
                        getValueForPixel: function (t) {
                            ...
                            i = e.isHorizontal(),
                            n = i ? e.width - (e.paddingLeft + e.paddingRight) : e.height - (e.paddingTop + e.paddingBottom),
                            o = n / a;
                            return e.options.gridLines.offsetGridLines && (t -= o / 2),
                            t -= i ? e.paddingLeft : e.paddingTop,
                            0 >= t ? 0 : Math.round(t / o)
                        }
                    });
                            ...
                            if (a.min = null, a.max = null, i.stacked) {
                                ...
                                e.each(r, function (o, r) {
                                    ...
                                    n.isDatasetVisible(r) && t(l) && e.each(o.data, function (t, e) {
                                        ...
                                        isNaN(n) || l.data[e].hidden || (d[e] = d[e] || 0, u[e] = u[e] || 0, i.relativePoints ? d[e] = 100 : 0 > n ? (!0, u[e] += n) : (!0, d[e] += n))
                                    })
                                }),
                                e.each(s, function (t) {
                ...
                e.exports = function (t) {
                    ...
                    t.LinearScaleBase = t.Scale.extend({
                        ...
                        buildTicks: function () {
                            ...
                            if (s)
                                l = n(i.fixedStepSize, i.stepSize);
                            else {
                ...
                e.exports = function (t) {
                    ...
                    i = t.Scale.extend({
                        ...
                        getPixelForValue: function (t, a, i, n) {
                            ...
                            h = l.paddingBottom,
                            f = l.paddingLeft;
                            return l.isHorizontal() ? 0 === d ? r = l.left + f : (o = l.width - (f + l.paddingRight), r = l.left + o / u * (e.log10(d) - e.log10(s)), r += f) : 0 === d ? r = l.top + c : (o = l.height - (c + h), r = l.bottom - h - o / u * (e.log10(d) - e.log10(s))),
                            r
                        },
                        getValueForPixel: function (t) {
                            var a,
                            ...
                            if (i.display) {
                                ...
                                if (e.each(t.ticks, function (r, l) {
                                        ...
                                        for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), p = s(l.fontSize, a.defaultFontSize), m = s(l.fontStyle, a.defaultFontStyle), b = s(l.fontFamily, a.defaultFontFamily), v = e.fontString(p, m, b), x = t.getValueCount() - 1; x >= 0; x--) {
                                            ...
                                            A = D > x || x > C - D,
                                            I = x === D || x === C - D;
                                            d.textAlign = 0 === x ? "center" : x === M ? "center" : M > x ? "left" : "right",
                                            d.textBaseline = I ? "middle" : A ? "bottom" : "top",
                ...
                e.exports = function (t) {
                    ...
                    o = t.Scale.extend({
                        ...
                        buildTicks: function (i) {
                            ...
                            n.ctx.save();
                            var o,
                            r = e.getValueOrDefault(n.options.ticks.fontSize, t.defaults.global.defaultFontSize),
                            l = e.getValueOrDefault(n.options.ticks.fontStyle, t.defaults.global.defaultFontStyle),
                            s = e.getValueOrDefault(n.options.ticks.fontFamily, t.defaults.global.defaultFontFamily),
                            d = e.fontString(r, l, s);
                            if (n.ctx.font = d, n.ticks = [], n.unitScale = 1, n.scaleSizeInUnits = 0, n.options.time.unit)
                                n.tickUnit = n.options.time.unit || "day", n.displayFormat = n.options.time.displayFormats[n.tickUnit], n.scaleSizeInUnits = n.lastTick.diff(n.firstTick, n.tickUnit, !0), n.unitScale = e.getValueOrDefault(n.options.time.unitStepSize, 1);
                            else {
                                var u = n.isHorizontal() ? n.width - (n.paddingLeft + n.paddingRight) : n.height - (n.paddingTop + n.paddingBottom),
                                c = n.tickFormatFunction(n.firstTick, 0, []),
                                h = n.ctx.measureText(c).width,
                                f = Math.cos(e.toRadians(n.options.ticks.maxRotation)),
                                g = Math.sin(e.toRadians(n.options.ticks.maxRotation));
                                h = h * f + r * g;
                                var p = u / h;
                                ...
                                for (var m = 0, b = a.units[m]; m < a.units.length; ) {
                                    if (n.unitScale = 1, e.isArray(b.steps) && Math.ceil(n.scaleSizeInUnits / p) < e.max(b.steps)) {
                                        for (var v = 0; v < b.steps.length; ++v)
                                            if (b.steps[v] >= Math.ceil(n.scaleSizeInUnits / p)) {
                                                n.unitScale = e.getValueOrDefault(n.options.time.unitStepSize, b.steps[v]);
                                                break
                                            }
                                        break
                                    }
                                    if (!1 === b.maxStep || Math.ceil(n.scaleSizeInUnits / p) < b.maxStep) {
                                    ...
                                    b = a.units[m],
                                    n.tickUnit = b.name;
                                    var x = n.firstTick.diff(n.getMomentStartOf(n.firstTick), n.tickUnit, !0),
                                    y = n.getMomentStartOf(n.lastTick.clone().add(1, n.tickUnit)).diff(n.lastTick, n.tickUnit, !0);
                                    n.scaleSizeInUnits = n.lastTick.diff(n.firstTick, n.tickUnit, !0) + x + y,
                                    n.displayFormat = n.options.time.displayFormats[b.name]
                                }
                            }
                            if (n.options.time.min ? o = n.getMomentStartOf(n.firstTick) : (n.firstTick = n.getMomentStartOf(n.firstTick), o = n.firstTick), !n.options.time.max) {
                            ...
                            e.each(n.chart.data.datasets, function (t, e) {
                            ...
                            for (var S = 1; S <= n.scaleSizeInUnits; ++S) {
                                var w = o.clone().add(S, n.tickUnit);
                                if (n.options.time.max && w.diff(n.lastTick, n.tickUnit, !0) >= 0)
                                    break;
                                S % n.unitScale == 0 && n.ticks.push(w)
                            }
                            var C = n.ticks[n.ticks.length - 1].diff(n.lastTick, n.tickUnit);
                            (0 !== C || 0 === n.scaleSizeInUnits) && (n.options.time.max ? (n.ticks.push(n.lastTick.clone()), n.scaleSizeInUnits = n.lastTick.diff(n.ticks[0], n.tickUnit, !0)) : (n.ticks.push(n.lastTick.clone()), n.scaleSizeInUnits = n.lastTick.diff(n.firstTick, n.tickUnit, !0))),
                            n.ctx.restore()
                        },
                        getLabelForIndex: function (t, e) {
                            var a = this,
                        ...
                        getPixelForValue: function (t, e, a, i) {
                            ...
                            if (o) {
                                ...
                                if (n.isHorizontal()) {
                                    ...
                                    d = (Math.max(n.ticks.length - 1, 1), s * l + n.paddingLeft);
                                    return n.left + Math.round(d)
                                }
                                var u = n.height - (n.paddingTop + n.paddingBottom),
                                c = (Math.max(n.ticks.length - 1, 1), u * l + n.paddingTop);
