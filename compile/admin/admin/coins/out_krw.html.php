<?php /* Template_ 2.2.6 2022/12/09 17:06:26 /home/ubuntu/www/admin/www/template/admin/admin/coins/out_krw.html 000003338 */ ?>
...
<h5>출금 내역</h5>
<!--                    {? currency_info.crypto_currency=='N'}<div class="text-right"><a href="?pg_mode=dividend&symbol={_GET.symbol}" class="btn btn-info"><i class="fa fa-diamond"></i> 배당</a></div>{/}-->
</div>
...
<th class="text-center"><?php if(strtoupper($_GET["symbol"])=='USD'){?>출금정보<?php }else{?>출금 주소<?php }?></th>
